...
// La clé secrété permetttant de générer les signatures des JWT
...
function extractJwtBody()
{
    ...
    // Si la signature envoyée est différente de celle regénérée,
    // il y a eu certainement une tentative de modification
